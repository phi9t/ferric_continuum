...
#               (default: $TMPDIR/deepseek-v41-mm-compat)
...
OUT_DIR="${OUT_DIR:-${TMPDIR:-/tmp}/deepseek-v41-mm-compat}"
BAZEL="${BAZEL:-bazel}"
...
# is worthless; this negative control guards against that. The comparator uses
# numpy, so run it through the same validated HF_PYTHON interpreter as the
# reference levels.
# ---------------------------------------------------------------------------
